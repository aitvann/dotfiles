...
// EgdyArc-fr tweak
user_pref("af.edgyarc.thin-navbar", true);
user_pref("af.sidebery.edgyarc-theme", true);
user_pref("af.sidebery.minimal-collapsed", true);
