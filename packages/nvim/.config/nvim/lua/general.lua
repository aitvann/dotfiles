...
end, { silent = true, desc = "Go to Word in the CURRENT buffer" })
vim.keymap.set("n", "gW", function()
	builtin.live_grep()
end, { silent = true, desc = "Go to Word in the PROJECT" })
vim.keymap.set("n", "gb", function()
	builtin.buffers()
end, { silent = true, desc = "Go to a buffer" })
vim.keymap.set("n", "gJ", function()
	builtin.jumplist()
end, { silent = true, desc = "Go to Jump point" })
vim.keymap.set("i", "<C-j>", function()
	telescope.extensions.emoji.search()
end, { silent = true, desc = "insert emoJi" })
