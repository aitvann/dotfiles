...
vim.keymap.set("x", "J", "<cmd>m '>+1<CR>gv=gv", { silent = true })
vim.keymap.set("x", "K", "<cmd>m '<-2<CR>gv=gv", { silent = true })
...
-- gp = Go Pull window
vim.keymap.set("n", "gph", "<C-W>h <C-W>x", { silent = true, desc = "Go to the LEFT, Pulling the current window with you" })
vim.keymap.set("n", "gpl", "<C-W>l <C-W>x", { silent = true, desc = "Go to the RIFHT, Pulling the current window with you" })
...
vim.keymap.set("n", '<S-Right>', function() vim.fn.ResizeRight(4) end, { silent = true, desc = 'move window divider RIGHT' })
...
vim.keymap.set("n", 'gw', function() builtin.current_buffer_fuzzy_find() end, { silent = true, desc = 'Go to Word in the CURRENT buffer' })
vim.keymap.set("n", 'gW', function() builtin.live_grep() end, { silent = true, desc = 'Go to Word in the PROJECT' })
vim.keymap.set("n", 'gb', function() builtin.buffers() end, { silent = true, desc = 'Go to a buffer' })
vim.keymap.set("n", 'gJ', function() builtin.jumplist() end, { silent = true, desc = 'Go to Jump point' })
vim.keymap.set("i", '<C-j>', function() telescope.extensions.emoji.search() end, { silent = true, desc = 'insert emoJi' })
